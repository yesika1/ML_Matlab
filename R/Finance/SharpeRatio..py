...
# visualize the stock_data (line plot)
...
# Select the S&P 500 prices as a Series from the benchmark_data using single brackets [] 
...
# Use the .sub() method to subtract
# Make sure to set the parameter axis=0 to align the dates for both time series.
excess_returns = stock_returns.sub(sp_returns, axis=0)

# plot the excess_returns
excess_returns.plot(title='Relative performance of stocks vs. the S&P 500 benchmark.')
...
# Use np.sqrt() to calculate the square root
# Use .mul() to multiply
